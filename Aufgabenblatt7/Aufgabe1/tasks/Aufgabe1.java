...
public class Aufgabe1 {
    ...
    public static Person createHubert() {
       Person hubert = new Person("Hubert", "Maier","Männlich", 88,1234);
       hubert.neuesKind(createJulia());
       Person gernot = new Person("Gernot", "Mueller", "Männlich", 40, 1115);
       Person roman = new Person("Roman", "Mueller", "Männlich", 12, 1116);
    ...
    public static Person createThomas() {
       Person thomas = new Person("Thomas", "Maier", "männlich", 22, 2222);
       return thomas;
    }
