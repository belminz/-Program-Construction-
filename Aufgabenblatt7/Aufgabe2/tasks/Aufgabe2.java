...
public class Aufgabe2 {
    ...
    static Archiv createArchiv() {
        ...
        archiv.registrieren(new Fisch("Hearing",250,20));
        archiv.registrieren(new Fisch("Walhai",0,2050));
        archiv.registrieren(new Fisch("Kaiserfisch", 1220, 20));
        archiv.registrieren(new Schildkroete("Meeresschildkroete", 33, 20));
        archiv.registrieren(new Saeugetier("Wal", 20004, 20000));
        archiv.registrieren(new Koralle("Lederkoralle", 40, 1000));
        archiv.registrieren(new Koralle("Feuerkoralle", 41, 1000));
        return archiv;
    }
    
    public static void main(String[] args) {
        Archiv archiv =createArchiv();
